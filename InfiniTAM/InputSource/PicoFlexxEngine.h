...
namespace InputSource
{
	...
	public:
		explicit PicoFlexxEngine(const char *calibFilename, const std::string *tcpAddress = nullptr, const char *deviceURI = NULL, const bool useInternalCalibration = false,
